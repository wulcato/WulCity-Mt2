...
exports.patchlistUrl = 'http://localhost/files.json';
exports.patchlistFolder = 'http://localhost/files/';
...
exports.patchSliderUrl = 'http://localhost/slider.json';
exports.patchSliderImages = 'http://localhost/slider/';
/*
...
exports.discordUrl = 'https://discord.gg/invite';
exports.serverName = 'WulCity';
exports.binaryName = 'metin2-test.exe';
exports.configName = 'config.exe';
exports.launchParameters = ['--something'];
exports.enableLocaleCfgUpdate = false; //if true the locale.cfg will be updated when changing the language.
